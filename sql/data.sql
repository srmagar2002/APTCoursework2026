...
IGNORE INTO users (username,email,password_hash,role,profileImg) VALUES
       ...
       ('paras','paras@paras.com','$2a$10$6IReMXxVy84EOiYzOBNH5OasR8dMUvzPVKPcP/Tcc66QPQl.aZYXC'/*Paras&123*/,'CUSTOMER','userImg/5.gif'),
...
VALUES (6, 626780, 'DELIVERED', DATE_ADD(NOW(), INTERVAL 5 DAY), NOW());
INSERT IGNORE INTO orders (userId, totalAmount, status, estimatedDelivery, createdAt)
VALUES (2, 164900, 'OUT_FOR_DELIVERY', DATE_ADD('2026-04-28', INTERVAL 5 DAY), '2026-04-28 10:00:00');
-- Orders
INSERT IGNORE INTO orders (userId, totalAmount, status, estimatedDelivery, createdAt)
VALUES
(2, 129999, 'SHIPPED',      '2026-05-25 14:00:00', '2026-04-02 10:15:00'),
(2, 89950,  'SHIPPED',      '2026-05-22 10:30:00', '2026-04-05 12:45:00'),
(3, 159900, 'IN_TRANSIT',   '2026-05-18 16:00:00', '2026-04-08 09:30:00'),
(2, 74999,  'PREPARING',    '2026-05-28 12:00:00', '2026-04-10 14:20:00'),
(4, 219999, 'PREPARING',    '2026-05-30 18:00:00', '2026-04-15 11:10:00'),
(5, 49999,  'PREPARING',    '2026-05-17 09:00:00', '2026-05-03 08:25:00'),
(2, 134949, 'PREPARING',    '2026-05-24 15:45:00', '2026-05-06 13:55:00'),
(6, 179989, 'DELIVERED',    '2026-05-29 11:15:00', '2026-05-09 17:40:00'),
(3, 99900,  'DELIVERED',    '2026-05-16 13:00:00', '2026-05-12 10:05:00'),
(7, 249999, 'DELIVERED',    '2026-06-01 17:30:00', '2026-05-18 19:30:00');
