    ...
    <c:choose>
        <c:when test="${not isRated}">
            <div class="rating-header">
                ...
                <button class="btn btn-primary" onclick="openReviewModal(); setAction('add')">Write a review</button>
            </div>

            <div class="rating-stars-section">
                <div class="stars interactive" id="ratingStars" onclick="setAction('add')">
                    ...
                    <div class="my-review-rating">
                        <div class="my-review-stars">
                            <c:forEach begin="1" end="5" var="starIndex">
                                <c:choose>
                                    <c:when test="${starIndex <= userRating.rating}">
    ...
    <div class="breakdown-stats">
        <div class="rating-summary">
            ...
            <div class="summary-stars">
                <c:forEach begin="1" end="5" var="starIndex">
                    <c:choose>
                        <c:when test="${starIndex <= avgRatingRounded}">
                            <svg width="14" height="14" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                            </svg>
                        </c:when>
    ...
    <c:forEach var="rating" items="${ratings}" varStatus="status">
        <div class="review-card">
            ...
            <div class="review-stars">
                <c:forEach begin="1" end="5" var="starIndex">
                    <c:choose>
                        <c:when test="${starIndex <= rating.rating}">
                            <svg width="14" height="14" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                            </svg>
                        </c:when>
